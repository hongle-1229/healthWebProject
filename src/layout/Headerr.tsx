...
const items: MenuItem[] = [
  ...
  getItem(<Link to="/first_aid">Tư vấn sơ cứu</Link>,
    'sub1',
    null,
    // [
...
const Headerr = () => {
  ...
  return (
    ...
    <div>
      ...
      <div className='header-all' style={{ backgroundColor: "rgb(225, 244, 251)", display: "flex", paddingTop: "10px", position: 'fixed', top: 0, zIndex: "1000", width: "100%" }}>
        <Link to="/home"><img src={logo} alt="" style={{ height: "55px", objectFit: "cover", paddingLeft: "90px", paddingBottom:"10px" }} /></Link>
        {/* <Menu className='menu-header ant-menu-item markazi-text-uniquifier' defaultSelectedKeys={['1']} mode="horizontal" items={items} style={{ backgroundColor: "rgb(225, 244, 251)", width: "100%", marginTop: "18px", marginLeft: "40px", fontSize: "22px" }} /> */}
          {isMobile ? (
          <>
            <Button
              icon={<MenuOutlined />}
              onClick={showDrawer}
              style={{ fontSize: "24px", border: "none", background: "none", paddingLeft: "350px", paddingTop:"15px" }}
            />
            <Drawer
              title="Danh mục"
              placement="right"
            ...
            >
              <Menu
                mode="vertical"
                items={items}
                onClick={onClose} // đóng Drawer khi click
              />
            </Drawer>
          </>
        ) : (
